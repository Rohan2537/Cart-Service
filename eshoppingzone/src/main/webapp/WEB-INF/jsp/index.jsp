...
<body>
	...
	<div class="col-sm-12">
		<nav class='navbar navbar-expand navbar-light bg-light'>
			<div class="col-sm-2">
				<a class='navbar-brand'><img src="https://github.com/EshoppingZone/Product_images/blob/experimental/logo.JPG?raw=true"
					alt="EShoppingZone"></a>
			</div>
			<div class="col-sm-3">
					...
					<li>
						<div class="dropdown">
							...
							<div class="dropdown-content">
								...
								<a href="/getProductsByCategory?category=footwears">FootWear</a>
								<a href="/getProductsByCategory?category=sports">Sports</a> 
								<a href="/getProductsByCategory?category=kitchen">Home & Kitchen</a> 
								<a href="/getProductsByCategory?category=bags and Luggage">Bags & Luggage</a>
							</div>
						</div>
					</li>
