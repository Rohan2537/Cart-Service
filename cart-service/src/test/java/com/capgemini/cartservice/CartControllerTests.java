...
public class CartControllerTests {
	...
	public void testGetCartsForPostMethod() throws Exception { 
		Cart cart = new Cart();
		ResponseEntity<String> response = restTemplate.postForEntity("/carts/101", cart, String.class);
	...
	public void testCartNotPresentInternalServerError() throws Exception {
		ResponseEntity<String> response = restTemplate.getForEntity("/carts/125", String.class);
